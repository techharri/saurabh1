...
<table class="table">
    ...
    <?php $__currentLoopData = $articlecat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $articlecatlist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            ...
            <td><?php echo e($articlecatlist->ap_cat); ?></td>
            <td><?php echo e($articlecatlist->created_at); ?></td>
            <td><?php echo e($articlecatlist->status); ?></td>
...
<?php echo $__env->make('admin.include.container', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\saurabh\resources\views/admin/articlecatlist.blade.php ENDPATH**/ ?>